...
export default function Homepage() {
  return (
    <div  data-scroll data-scroll-section data-scroll-speed=".15"  className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-0 pb-0 gap-0 sm:p-35 font-[family-name:var(--font-geist-sans)] bg-gradient-to-b  from-[#88BDF2] to-white w-full ">
